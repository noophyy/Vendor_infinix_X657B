...
CUSTOM_BUILD_VERNO = CY-X657B-H6117-D
#BSP: add project macro by wanghanfeng 20201102 start
...
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw gc803430fps_mipi_raw gc803430fpsext2_mipi_raw ov8856ff_mipi_raw gc6153_serial_yuv gc6133_serial_yuv gc6153main3_serial_yuv pblcs5k3l6_mipi_raw pblcs5k3l6ext2_mipi_raw pblcgc803430fps_mipi_raw pblcgc803430fpsext2_mipi_raw pblcov8856ff_mipi_raw pblcgc6153_serial_yuv pblcgc6133_serial_yuv pblcgc6153main3_serial_yuv
CUSTOM_HAL_MAIN2_IMGSENSOR = gc6153_serial_yuv gc6133_serial_yuv
CUSTOM_HAL_MAIN3_IMGSENSOR = gc6153main3_serial_yuv
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw

TRAN_CAMERA_FAKE_STEREO_SAME_CLK_WITH_MAIN_SEC = yes
MTK_CAM_MAX_NUMBER_OF_CAMERA = 4
#ITD:modify by camera driver team end
#BSP: modify XLWQBCPUB-893 [P1 sensor debug] by tao.lan 20201103 start
CUSTOM_HAL_MSENSORLIB =
#BSP: modify XLWQBCPUB-893 [P1 sensor debug] by tao.lan 20201103 end
CUSTOM_HAL_SENSORS = sensor
#ITD:modify by camera driver team start
CUSTOM_HAL_SUB_IMGSENSOR = gc803430fps_mipi_raw gc803430fpsext2_mipi_raw ov8856ff_mipi_raw
#ITD:modify by camera driver team end
...
#BSP: modify XLWQBCPUB-893 [P1 sensor debug] by tao.lan 20201103 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw gc803430fps_mipi_raw gc803430fpsext2_mipi_raw ov8856ff_mipi_raw gc6153_serial_yuv gc6133_serial_yuv gc6153main3_serial_yuv
#ITD:modify by camera driver team end
...
CUSTOM_KERNEL_MAIN3_IMGSENSOR = gc6153main3_serial_yuv
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw
#ITD:modify by camera driver team end
#BSP: modify XLWQBHLAEE-207 [open sifnificant] by yilong.luo 20210816 start
...
#BSP: modify XLWQBHLAEE-207 [open sifnificant] by yilong.luo 20210816 end
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_STATIONARY_SENSOR = yes
CUSTOM_KERNEL_STEP_COUNTER = yes
#ITD:modify by camera driver team start
CUSTOM_KERNEL_SUB_IMGSENSOR = gc803430fps_mipi_raw gc803430fpsext2_mipi_raw ov8856ff_mipi_raw
#ITD:modify by camera driver team end
...
#TDD: modify CMSFTASK-202 by yi.liu5 20210810 start
CUSTOM_MODEM=x657c_h6117_g1_go_nonejo
#TDD: modify CMSFTASK-202 by yi.liu5 20210810 end
...
#BSP:modify AAL support XLWQBCRPUB-14 by you.tan 20210826 start
MTK_AAL_SUPPORT = yes
#BSP:modify AAL support XLWQBCRPUB-14 by you.tan 20210826 end
...
#BSP:modify audio bring up XLWQBCPUB-899 xinyu.zhao 20210929 start
MTK_AUDIO_HD_REC_SUPPORT = yes
#BSP:modify audio bring up XLWQBCPUB-899 xinyu.zhao 20210929 end
MTK_AUDIO_HYBRID_NLE_SUPPORT = no
MTK_AUDIO_MIC_INVERSE = no
#BSP:modify audio bring up XLWQBCPUB-899 haiping.bai 20201118 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify audio bring up XLWQBCPUB-899 haiping.bai 20201118 end
...
#BSP:modify audio open drc XLWQBCRPUB-154 xinyu.zhao 20210818 start
MTK_BESLOUDNESS_SUPPORT = yes
#BSP:modify audio open drc XLWQBCRPUB-154 xinyu.zhao 20210818 end
...
#TDD: modify VSIM XLWQBCRPUB-157 by yi.liu5 20211021 start
MTK_EXTERNAL_SIM_ONLY_SLOTS = 4
MTK_EXTERNAL_SIM_SUPPORT = yes
MTK_EXTERNAL_SIM_RSIM_ENHANCEMENT = yes
#TDD: modify VSIM XLWQBCRPUB-157 by yi.liu5 20211021 end
...
#NFBD:add fm enable XLWQBCRPUB-186 by tieshan.huang 20210826 start
MTK_FMRADIO_APP = yes
...
#NFBD:add fm enable test XLWQBCRPUB-186 by tieshan.huang 20210826 end
...
#TDD: modify for XLWQBCRPUB-157 by yi.liu5 20210825 start
MTK_MULTIPLE_IMS_SUPPORT = 2
#TDD: modify for XLWQBCRPUB-157 by yi.liu5 20210825 end
...
#SPD:modify aal KFLHLEYJ-30 by shuaishuai.ren 20201216 start
MTK_PQ_SUPPORT = PQ_HW_VER_2
#SPD:modify aal KFLHLEYJ-30 by shuaishuai.ren 20201216 end
...
#NFBD:modify WFD XLWQBCRPUB-67 by changli.chen 20210827 start
MTK_WFD_SUPPORT = yes
#NFBD:modify WFD XLWQBCRPUB-67 by changli.chen 20210827 end
...
#[ITD]modify for camera config by xuelong.chen 20210818 start
MTK_CAM_BGSERVICE_SUPPORT = yes
#[ITD]modify for camera config by xuelong.chen 20210818 end
...
#TDD: modify XLWQBCRPUB-100 by yi.liu5 20210822 start
MTK_DYNAMIC_CCB_BUFFER_GEAR_ID = 2
#TDD: modify XLWQBCRPUB-100 by yi.liu5 20210822 end
...
#BSP: modify XLWBBHLEYJ-192 [modify mtk-patch err] by tao.lan 20201224 start
MTK_TINYSYS_SCP_LOGGER_SUPPORT = yes
#BSP: modify XLWBBHLEYJ-192 [modify mtk-patch err] by tao.lan 20201224 end
...
MTK_BUILD_VERNO=X657B-H6117EIKL-RGo-OP-S2-221121V777
TRAN_FINGERPRINT_BUILD_VERNO=221121V777
#SDD: add project sw version by jiangping.guo 20201102 end
#BSP: add project macro by wanghanfeng 20201102 start
CUSTOM_TRAN_PROJECT=tran_x657b
CUSTOM_TRAN_BOM=tran_x657b_d1
